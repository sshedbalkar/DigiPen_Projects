...
Plane3D Transformation::Transform(const Plane3D& P)
{
	// NOTE:  The matrix indexing is transposed here
	return Plane3D(
	 inv[0][0]*P[0] + inv[1][0]*P[1] + inv[2][0]*P[2] + inv[3][0]*P[3],
	 inv[0][1]*P[0] + inv[1][1]*P[1] + inv[2][1]*P[2] + inv[3][1]*P[3],
	 inv[0][2]*P[0] + inv[1][2]*P[1] + inv[2][2]*P[2] + inv[3][2]*P[3],
	 inv[0][3]*P[0] + inv[1][3]*P[1] + inv[2][3]*P[2] + inv[3][3]*P[3]
	);
}

Plane3D Transformation::InverseTransform(const Plane3D& P)
{
	// NOTE:  The matrix indexing is transposed here
	return Plane3D(
	 curr[0][0]*P[0] + curr[1][0]*P[1] + curr[2][0]*P[2] + curr[3][0]*P[3],
	 curr[0][1]*P[0] + curr[1][1]*P[1] + curr[2][1]*P[2] + curr[3][1]*P[3],
	 curr[0][2]*P[0] + curr[1][2]*P[1] + curr[2][2]*P[2] + curr[3][2]*P[3],
	 curr[0][3]*P[0] + curr[1][3]*P[1] + curr[2][3]*P[2] + curr[3][3]*P[3]
	);
}
