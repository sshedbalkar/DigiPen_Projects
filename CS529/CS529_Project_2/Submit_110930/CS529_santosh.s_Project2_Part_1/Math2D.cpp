/* Start Header -------------------------------------------------------
Copyright (C) 211 DigiPen Institute of Technology. Reproduction or disclosure of this file or its contents without the prior written consent of DigiPen Institute of Technology is prohibited.
...
Project			: CS529_SantoshShedbalkar_Project2_1
...
/*
This function checks whether an animated point is colliding with a thick line segment
...
float AnimatedPointToStaticThickLineSegment(Vector2D &Ps, Vector2D &Pe, LineSegment2D &LS, Vector2D &Ph, float halfThickness)
{
	...
	else if((mNdotV = Vector2DDotProduct(LS.mN, Vel)) == 0)
	{
