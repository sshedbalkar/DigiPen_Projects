...
namespace Wye
{
    ...
    //   with D3DCREATE_SOFTWARE_VERTEXPROCESSING.
		...
		/////D3DXMatrixPerspectiveFovLH( &matProj, D3DXToRadian( 60.0f ), 1.25f, 1.0f, 100.0f );
		//D3DXMatrixPerspectiveFovLH(&matProj, D3DXToRadian(20.0f), 1.25f, 1.0f, 100.0f);
		//D3DXMatrixPerspectiveLH( &matProj, _surfaceSize.x, _surfaceSize.y, 1.0f, 1000.0f );
	...
	{
		HRESULT hr;
		hr = D3DXCreateFont(_pDevice, 16, 0, FW_NORMAL, 0, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, TEXT("Calibri"), &_pFont);
