...
*/
		...
		case IDC_TOGGLEHEURISTICWEIGHT:
			...
			g_astar.setWeight( g_heuristicWeight );
		...
		case IDC_TOGGLEHEURISTIC:
			...
			g_astar.changeHeuristic( g_heuristicCalc );
		...
		case IDC_TOGGLESMOOTHING:
			...
			g_astar.setSmoothing( g_smoothing );
		...
		case IDC_TOGGLERUBBERBANDING:
			...
			g_astar.setRubberband( g_rubberbanding );
		...
		case IDC_TOGGLESTRAIGHTLINE:
			...
			g_astar.setStraightline( g_straightline );
