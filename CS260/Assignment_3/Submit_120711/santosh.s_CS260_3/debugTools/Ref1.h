...
virtual void run()
{
    ...
    do
    {
        // Halt until an event of interest occurs…
        // – Input is available from the console input
        // – The thread has been signaled to shutdown
        // …then dispatch to the appropriate code.
        //
        HANDLE hStdInput = ::GetStdHandle(STD_INPUT_HANDLE);
        HANDLE hArray[2] = { hStdInput, m_hExitEvent };
