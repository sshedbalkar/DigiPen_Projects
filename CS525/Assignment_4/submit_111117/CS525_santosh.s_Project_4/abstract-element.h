...
/*!
	...
	\brief Interface for elements. Class is derived from ObjectCounter<AbstractElement> to implement object counting using Curiously Recurring Template Pattern
 */
