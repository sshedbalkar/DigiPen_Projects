...
bool TransparentShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, "Shaders//transparent.vs", "Shaders//transparent.ps");
	if(!result)
	{
		return false;
	}
...
bool TransparentShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, char* vsFilename, char* psFilename)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "TransparentVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "TransparentPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 
...
void TransparentShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, char* shaderFilename)
{
	char* compileErrors;
