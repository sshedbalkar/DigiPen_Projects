...
void test24(void) {
  ...
  for(i=0;i<4;++i) {
	  for(j=0;j<4;++j) {
		  insert_element2(&pR1,i,j,i*4+j+1);
	  }
  }
  insert_element2(&pR1,2,0,1);
  insert_element2(&pR1,3,0,1);
  insert_element2(&pR1,3,1,1);
  /*
	 1  2  3  4
	 5  6  7  8
	 1  10 11 12 
...
test19, test20, test21, test22, test23, test24, test25}; /*extra*/
